package com.example.picmejava.configuration.security;
...
public class SecurityConfiguracao {
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/fotografos/entrar/**"),
            new AntPathRequestMatcher("/fotografos/cadastrar/**"),
            new AntPathRequestMatcher("/fotografos/sair/**"),
            new AntPathRequestMatcher("/clientes/entrar/**"),
            new AntPathRequestMatcher("/clientes/cadastrar/**"),
            new AntPathRequestMatcher("/clientes/sair/**"),
            new AntPathRequestMatcher("/instagram/**"),
