...
public class InstagramService {
    ...
    public Mono<AccessToken> postUsuarioInsta(String codigo){
        String cURL = "http://3.95.204.15:8080/instagram/access_token";
    ...
    public Mono<ListData> getImagensInsta(String accessToken) {
        String cURL = "http://3.95.204.15:8080/instagram/lista_imagens?accessToken=" + accessToken;
    ...
    public Mono<Media> getImagem(String idImagem, String accessToken) {
        String cURL = String.format("http://3.95.204.15:8080/instagram/imagem?idImagem=%s&accessToken=%s", idImagem, accessToken);
    ...
    public Mono<LongAccessToken> getLongAccessToken(String accessToken) {
        ...
        String cURL = String.format("http://3.95.204.15:8080/instagram/long_access_token?accessToken=%s", accessToken);
    ...
    public Mono<LongAccessToken> getRefreshedLongAccessToken(String accessToken) {
        ...
        String cURL = String.format("http://3.95.204.15:8080/instagram/refresh_access_token?accessToken=%s", accessToken);
